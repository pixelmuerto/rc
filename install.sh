...
cd $dirLocal
repos=( msanders/snipmate.vim.git ervandew/supertab.git vim-scripts/python_fold.git vim-scripts/xoria256.vim.git vim-scripts/mayansmoke.git pixelmuerto/vim-pixelmuerto.git hallison/vim-markdown.git )
for repo in ${repos[@]}
do
